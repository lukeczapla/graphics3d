...
//            cycleModel.setTranslateY(50.0);
            ...
            // just for the plane.fxml file with propeller
            (cycleModel.getChildren().get(2)).setRotationAxis(new Point3D(0.0,0.0,1.0));
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(10), event -> {
            ...
            step++;
            // just for the plane:
            (cycleModel.getChildren().get(2)).setRotate((cycleModel.getChildren().get(2)).getRotate()+27.0);
        }
        ));
