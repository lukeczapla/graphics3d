...
public class MyScene {
    ...
    public PhongMaterial makeMaterial(String filename) {
        Image diffuseMap = new Image(MyScene.class
    ...
    public MyScene() {
        ...
        Cylinder cylinder = new Cylinder(20.0, 25.0);
...
/*      (CODE FOR READING JUST A MESHVIEW FILE)
            ...
            cycleModel.setTranslateX(0.0);
            cycleModel.setTranslateY(0.0);
            cycleModel.setTranslateZ(0.0);

            cycleModel.setScaleX(10.0);
            cycleModel.setScaleY(10.0);
            cycleModel.setScaleZ(10.0);
...
//            cycleModel.setTranslateY(50.0);
            ...
            // just for the plane.fxml file with the propeller
            prop = (MeshView)cycleModel.lookup("#prop");
            if (prop != null) prop.setRotationAxis(new Point3D(0.0,0.0,1.0));
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(10), event -> {
            ...
            step++;
            // just for the plane:
            if (prop != null) prop.setRotate(prop.getRotate()+27.0);
        }
        ));
